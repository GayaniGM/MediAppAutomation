...
public class tc_002 {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(tc_002.class);
	
	AndroidDriver mobiledriver;
	
	@SuppressWarnings({ "resource", "unused" })
	@Test(priority = 0, description = "UI Verification of Home Page")
	public void tc002() throws Exception{
		
		LOGGER.info("Starting test case tc002...");
		Reporter.log("Starting test case tc002...");
		...
		//Get absolute file path
		 Path path = Paths.get("src\\main\\java\\com\\test\\automation\\data\\tc_002.xlsx");
        ...
        home.ValidateMyAppointmentsButtonText(sheet.getRow(1).getCell(0).toString());
        ...
        home.ValidateAddAppointmentsButtonText(sheet.getRow(2).getCell(0).toString());
        ...
        LOGGER.info("Test case tc002 execution completed successfully.");
        Reporter.log("Test case tc002 execution completed successfully.");
	...
	@SuppressWarnings({ "resource", "unused" })
	@Test(priority = 1, description = "Verify My Appointments page")
	public void tc001() throws Exception{
		...
		//Get absolute file path
		 Path path = Paths.get("src\\main\\java\\com\\test\\automation\\data\\tc_003.xlsx");
	     Path absolutePath = path.toAbsolutePath();
        ...
        appointmentPage.VerifyFindNewAppointment(sheet.getRow(2).getCell(0).toString());
	...
	@SuppressWarnings({ "resource", "unused" })
	@Test(priority = 2, description = "Verify View Appointments page")
	public void tc003() throws Exception{
		...
		//Get absolute file path
		 Path path = Paths.get("src\\main\\java\\com\\test\\automation\\data\\tc_004.xlsx");
	     Path absolutePath = path.toAbsolutePath();
        ...
        //Verify header page
        appointmentPage.ValidateViewAppointment(sheet.getRow(2).getCell(0).toString());
	...
	@Test(priority = 3, description = "Verify Update Running Number Page")
